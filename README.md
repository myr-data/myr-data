...
**Machine Learning & Data Science:** Pandas, Polars, NumPy, Scikit-learn,
TensorFlow, Keras, PyTorch, Optuna, LightGBM, XGBoost

**NLP & LLM Systems:** NLP, LLM, RAG, Embedding, Semantic Search,
Prompt Engineering

**Data Engineering:** Pipelines, ETL/ELT, Preprocessing, Standardization

**MLOps & Backend:** FastAPI, REST API, Docker, Compose, Kubernetes,
